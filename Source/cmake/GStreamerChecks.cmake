if (ENABLE_VIDEO OR ENABLE_WEB_AUDIO)
    ...
    SET_AND_EXPOSE_TO_BUILD(USE_GSTREAMER TRUE)
      if (USE_GSTREAMER_FULL)
          ...
          if (USE_GSTREAMER_WEBRTC AND (PC_GSTREAMER_VERSION VERSION_LESS "1.16" OR NOT PC_GSTREAMER_WEBRTC_FOUND))
              message(FATAL_ERROR "GStreamerWebRTC >= 1.16 is needed for USE_GSTREAMER_WEBRTC.")
          endif ()
      endif ()
endif ()
